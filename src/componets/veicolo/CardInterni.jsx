      ...
      <div className="cardInterni">
        <div className="d-flex flex-column">
          ...
          <div>
            ...
            <p style={{ width: "360px" }}>{vehicle.vehiclesArrangement.descriptionKitchen}</p>
          </div>
        </div>
        <div>
          <div className="d-flex flex-column">
            ...
            <div>
              ...
              <p style={{ width: "360px" }}>{vehicle.vehiclesArrangement.descriptionBathroom}</p>
            </div>
          </div>
        </div>
        <div>
          <div className="d-flex flex-column">
            <span>Accessori</span>
            <div>
              <p style={{ width: "360px" }}>{vehicle.vehiclesArrangement.accessoriesDescription}</p>
            </div>
          </div>
        </div>
      </div>
